import { IExecutionResult, IHttp, IModify, IRead } from '../accessors';
...
export interface IPostMessageSentHandler {
     ...
     */
    executePostMessageSent(message: IMessage, read: IRead, http: IHttp, modify: IModify): IExecutionResult;
}
